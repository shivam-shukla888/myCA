...
import StateWrapper, { StateCode } from '../components/StateWrapper';
    ...
    <StateWrapper
      stateCode={
        isSaving
          ...
          : successMsg
          ? StateCode.SUCCESS
          : !draft && (inputMode === 'nlp' || inputMode === 'manual')
          ? StateCode.EMPTY
          : StateCode.UNKNOWN
      }
      error={error}
      onRetry={handleConfirmAndSave}
      fallback={
        <div style={{ padding: '8px 12px', background: 'var(--canvas-surface)', border: '1px solid var(--border-hairline)' }}>
          <p>Select a mode to begin entry.</p>
        </div>
      }
    >
      <div
          ...
          <form onSubmit={handleExtractFromText} style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
              ...
              <button
                ...
                style={{ padding: '0 16px', display: 'flex', alignItems: 'center', gap: '6px', minHeight: '44px', flex: '1 1 auto', justifyContent: 'center' }}
              >
                Parse & Preview
              </button>
            </div>
          ...
          >
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '10px', flexWrap: 'wrap' }}>
              ...
              <button
                ...
                className="instrument-btn"
                style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', minHeight: '44px', flex: '2 1 auto' }}
              >
